...
// const CustomerID = 'recIR0mXcMIQx6nww';
// const DiagnosticID = 'GYrecHZGtfbbofwcqhj';

console.log("newAlgorith Nr Start");

const calculate = async (DiagnosticID) => {
   ...
   try {
      ...
      const [diagnosticAnswerViewRecords, dietsViewRecords, foodViewRecords] = await Promise.all([
         getViewDataByID(gutify_base, DIAGNOSTIC_TABLE, DIAGNOSTIC_ANSWER_VIEW, DIAGNOSTIC_ANSWER_FIELDS, 'Diagnostic_ID', DiagnosticID),
         getViewDataByID(gutify_base, DIAGNOSTIC_TABLE, DIETS_VIEW, DIETS_FIELDS, 'Diagnostic_ID', DiagnosticID),
      ...
      const answerID = diagnosticAnswerViewData['Q14. Are you pregnant?'];
